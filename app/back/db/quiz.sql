...
VALUES
 ...
 ("to enable people to learn to read and write ", NULL, 1, 2),
  ("for fun ", NULL, 0, 2),
...
("The country of the red dot ", NULL, 0, 11),
  ("The country of the rising sun ", NULL, 1, 11),
